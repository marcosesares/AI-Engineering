...
- Picked → append refactor Task to [queue.json](../../../skills/e2e-engineering/schemas/queue.json.md) (`status:todo`, `selected:false`, refactor-shaped — runs FULL flow, ADR 0012). `behaviorPreserved` seeds the safety-net acceptance criterion.
