...
## What to check
- **[backend standard](../../skills/e2e-engineering/standards/backend.md) — all checks** (ownership/seams, layering, coupling, API shape/contracts/idempotency/path-param validation), plus:
