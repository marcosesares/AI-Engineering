...
- Picked → append refactor Task to `queue.json` (`status:needs-spec`, `selected:false`, refactor-shaped — runs FULL flow incl. its own PRD, ADR 0012/0029). `behaviorPreserved` seeds the safety-net acceptance criterion.
