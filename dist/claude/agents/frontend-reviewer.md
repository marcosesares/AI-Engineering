...
- [ui-design.md](../../skills/e2e-engineering/standards/ui-design.md) — the generic anti-slop standard.
- The approved [DESIGN.md](../../skills/e2e-engineering/schemas/design.md) — the project design system (scoped slice via §Index).
